...
const EditKematian = () => {
    ...
    const updateKematian = async (e) => {
        e.preventDefault();
        try {
            await axios.patch(`http://localhost:5000/Kematian/${id}`,{
                nik,
                nama,
                penyebab
            });
    ...
    const getKematianById = async () => {
        const response = await axios.get(`http://localhost:5000/Kematian/${id}`);
            ...
            <div className="bg-white h-screen">
                <div className="inline-flex gap-x-0">
                    ...
                    <form onSubmit={updateKematian}>
                            ...
                            <div className="w-full lg:mx-auto pl-5 mt-1">
