...
const EditKK = () => {
    ...
    const updateKK = async (e) => {
        e.preventDefault();
        try {
            await axios.patch(`http://localhost:5000/KK/${id}`,{
                nokk,
                nama_kk,
                anggota,
            });
    ...
    const getKKById = async () => {
        const response = await axios.get(`http://localhost:5000/KK/${id}`);
        console.log(response)
        setnokk(response.data.nokk);
        setnamakk(response.data.nama_kk);
        ...
        <div className="container scroll-mx-0">
            <div className="bg-white h-screen">
                <div className="grid grid-cols-5 gap-x-0">
                    ...
                    <div className="w-auto mt-4 ml-4 text-2xl">Edit Data Warga
                    <form onSubmit={updateKK}>
