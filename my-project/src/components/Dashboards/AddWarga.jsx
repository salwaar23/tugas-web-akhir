        ...
        <div className="container scroll-mx-0">
            <div className="bg-white h-screen">
                <div className="inline-flex gap-x-0">
                    <div className="bg-blue-500 h-screen w-[310px]">
                        ...
                        <div className="">
                            <Link to={`/Dashboard`}>
                                <div className="inline-flex gap-x-0 mt-10 ">
                                    ...
                                    <div className="ml-7 text-white text-xl pr-[102px]">Dashboard</div>
                                </div>
                            </Link>
                            <Link to={`/KelolaData`}>
                                <div className="inline-flex gap-x-0 mt-5  bg-blue-700 py-3 pr-10">
                                    <div className="ml-4 text-white text-xl mt-1"><FaDatabase /></div>
                                    <div className="ml-9 text-white text-xl pr-[53px]">Kelola Data</div>
                                </div>
                            </Link>
                            <Link to={`/Sirkulasi`}>
                                <div className="inline-flex mt-5">
                                    <div className="mt-1 ml-5 text-white text-xl"><FcStatistics /></div>
                                    <div className="ml-7 pl-1 text-white text-xl">Sirkulasi Penduduk</div>
                                </div>
                            </Link>
                            <Link to={`/Dokumen`}><div className="grid grid-cols-2 mt-5">
                                <div className="mt-1 ml-5 text-white text-xl"><FaMailBulk/></div>
                                <div className="-ml-16 pl-1 text-white text-xl">Dokumen</div>
                            </div></Link>
                            <Link to={`/Login`}>
