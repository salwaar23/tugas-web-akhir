...
const AddDatang = () => {
    ...
    const saveDatang = async (e) => {
        e.preventDefault();
        try {
            await axios.post("http://localhost:5000/Datang", {
                datangid,
                nama,
                pelapor
            });
        ...
        <div className="container scroll-mx-0">
            <div className="bg-white h-screen">
                <div className="inline-flex gap-x-0">
                    ...
                    <div className="w-auto mt-4 ml-4 text-2xl"> Tambah Data Kedatangan
                        <form onSubmit={saveDatang}>
